...
{
    public partial class conPlanCuentasAdmin : System.Web.UI.Page
    {
        ...
        protected void CrystalReportViewer1_Init(object sender, EventArgs e)
        {
            ...
            string tablas = "public.plan_cuentas, public.entidades, public.monedas";

            string where = "plan_cuentas.id_modenas = monedas.id_monedas AND entidades.id_entidades = plan_cuentas.id_entidades";
