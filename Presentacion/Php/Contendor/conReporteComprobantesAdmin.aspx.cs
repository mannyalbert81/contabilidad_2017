...
{
    public partial class conReporteComprobantesAdmin : System.Web.UI.Page
    {
        ...
        protected void CrystalReportViewer1_Init(object sender, EventArgs e)
        {
            ...
            string where = "ccomprobantes.id_forma_pago = forma_pago.id_forma_pago AND ccomprobantes.id_entidades= entidades.id_entidades AND usuarios.id_usuarios = ccomprobantes.id_usuarios AND tipo_comprobantes.id_tipo_comprobantes = ccomprobantes.id_tipo_comprobantes";

            //para cambiar el where
            string order = "ccomprobantes.numero_ccomprobantes";
            ...
            if (!String.IsNullOrEmpty(parametros.numero_comprobantes))
            {
                ...
                where_to += " AND ccomprobantes.numero_ccomprobantes LIKE '%" + parametros.numero_comprobantes + "%' ";
            }

            if (!String.IsNullOrEmpty(parametros.referencia_doc_comprobantes))
            {

                where_to += " AND ccomprobantes.referencia_doc_ccomprobantes LIKE '%" + parametros.referencia_doc_comprobantes + "%'";
            }
